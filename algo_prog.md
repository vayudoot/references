...
* [Self organizing sorted linked list in C++](https://medium.com/@vardanator/self-organizing-sorted-linked-list-in-c-ae24b7e0b600)
* [C++ MCS locks](https://libfbp.blogspot.in/2018/01/c-mellor-crummey-scott-mcs-lock.html)
* [Design patterns](https://en.wikibooks.org/wiki/C%2B%2B_Programming/Code/Design_Patterns)

# Python
* [Pickle](https://docs.python.org/2/library/pickle.html)
* [How list/dict/str is implemeneted in Python](http://www.laurentluce.com/posts/tag/python/)
